...
public class AddReceipt extends AppCompatActivity {
    ...
    private static class LableDetectionTask extends AsyncTask<Object, Void, String> {
        private final WeakReference<AddReceipt> mActivityWeakReference;
        private Vision.Images.Annotate mRequest;

        LableDetectionTask(AddReceipt activity, Vision.Images.Annotate annotate) {
        ...
        protected void onPostExecute(String result) {
            AddReceipt activity = mActivityWeakReference.get();
